...
<main id="MainContent" class="content-for-layout">
    ...
    <!-- latest blog start -->
    <div class="latest-blog-section bg-tan mt-100 pt-100 pb-100 overflow-hidden home-section">
    ...
    <!-- faq start -->
    <div class="faq-section mt-600 overflow-hidden">
        <div class="faq-inner">
            <div class="container">
                <div class="section-header text-center">
    ...
    <div class="newsletter-section mt-100 overflow-hidden">
        <div class="newsletter-inner">
            <div class="container">
                <div class="newsletter-container bg-tan">
